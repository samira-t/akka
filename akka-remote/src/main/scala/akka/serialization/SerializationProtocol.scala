 ...
 * </pre>
 */
trait StatelessActorFormat[T <: Actor] extends Format[T] with java.io.Serializable {
 ...
 * </pre>
 */
trait SerializerBasedActorFormat[T <: Actor] extends Format[T] with java.io.Serializable {
